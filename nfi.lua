...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://github.com/TDAIP/HuconX/raw/refs/heads/main/nfi.lua'))()")
	end
end)
...
local HitboxedPlayers = {} -- Lưu thông tin những người đã chỉnh hitbox
