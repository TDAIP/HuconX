...
function NoxUI:CreateMenu(config)
    ...
    function self:AddTab(config)
        ...
        Tab.Content.Visible = false -- Đảm bảo tab đầu tiên không hiển thị ngay

        -- Khi người dùng nhấn vào Tab Button, ẩn các tab khác và hiển thị tab hiện tại
        TabButton.MouseButton1Click:Connect(function()
            -- Ẩn nội dung của tất cả các tab
